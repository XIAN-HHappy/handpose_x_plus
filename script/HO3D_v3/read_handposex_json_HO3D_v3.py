...
if __name__ == '__main__':
    ...
    out_cnt = 0
    hand_cnt = 0
    for doc_ in os.listdir(path_root):
        path_doc_ = path_root + doc_ + "/"
        path_s_image = "{}/image/".format(path_doc_)
        path_s_label = "{}/label/".format(path_doc_)
        for f_ in os.listdir(path_s_image):
            ...
            out_cnt += 1
            print("--------->>> HO3D imgs_num : [{}] , hands_num: [{}]".format(out_cnt,hand_cnt))
